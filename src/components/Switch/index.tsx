...
const Switch = forwardRef<IFromItemRefs<boolean>, IFromItemProps<boolean>>((props, ref) => {
  ...
  return (
    <Label className={`${props.class ? props.class : 'mb-6'}`}>
      <div className="flex items-center overflow-hidden  mt-2 ">
        {props.label && <h4 className="mb-1 text-lg shrink-0 text-gray-700 dark:text-gray-200 mr-6">{props.label}</h4>}
